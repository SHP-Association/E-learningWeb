...
func (_c *CategoryCreate) SetImage(v string) *CategoryCreate {
	_c.mutation.SetImage(v)
	return _c
}

// SetNillableImage sets the "image" field if the given value is not nil.
func (_c *CategoryCreate) SetNillableImage(v *string) *CategoryCreate {
	if v != nil {
		_c.SetImage(*v)
	}
	return _c
...
func (_c *CategoryCreate) AddCourseIDs(ids ...int) *CategoryCreate {
	_c.mutation.AddCourseIDs(ids...)
	return _c
}

// AddCourses adds the "courses" edges to the Course entity.
func (_c *CategoryCreate) AddCourses(v ...*Course) *CategoryCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *CategoryCreate) AddFaqIDs(ids ...int) *CategoryCreate {
	_c.mutation.AddFaqIDs(ids...)
	return _c
}

// AddFaqs adds the "faqs" edges to the FAQ entity.
func (_c *CategoryCreate) AddFaqs(v ...*FAQ) *CategoryCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddFaqIDs(ids...)
}
...
func (_c *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.FaqsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
