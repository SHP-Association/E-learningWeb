...
func (tx *Tx) init() {
	tx.AnswerChoice = NewAnswerChoiceClient(tx.config)
	...
	tx.UserQuizAttempt = NewUserQuizAttemptClient(tx.config)
}
...
// applies a query, for example: AnswerChoice.QueryXXX(), the query will be executed
