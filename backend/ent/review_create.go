...
func (_c *ReviewCreate) SetIsApproved(v bool) *ReviewCreate {
	_c.mutation.SetIsApproved(v)
	return _c
}

// SetNillableIsApproved sets the "is_approved" field if the given value is not nil.
func (_c *ReviewCreate) SetNillableIsApproved(v *bool) *ReviewCreate {
	if v != nil {
		_c.SetIsApproved(*v)
	}
	return _c
...
func (_c *ReviewCreate) SetStudentID(id int) *ReviewCreate {
	_c.mutation.SetStudentID(id)
	return _c
}

// SetStudent sets the "student" edge to the User entity.
func (_c *ReviewCreate) SetStudent(v *User) *ReviewCreate {
...
func (_c *ReviewCreate) check() error {
	...
	if _, ok := _c.mutation.IsApproved(); !ok {
		return &ValidationError{Name: "is_approved", err: errors.New(`ent: missing required field "Review.is_approved"`)}
	}
...
func (_c *ReviewCreate) createSpec() (*Review, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.StudentIDs(); len(nodes) > 0 {
		...
		_node.user_reviews_given = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
