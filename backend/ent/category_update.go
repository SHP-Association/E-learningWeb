...
func (_u *CategoryUpdate) SetImage(v string) *CategoryUpdate {
	_u.mutation.SetImage(v)
	return _u
}

// SetNillableImage sets the "image" field if the given value is not nil.
func (_u *CategoryUpdate) SetNillableImage(v *string) *CategoryUpdate {
	if v != nil {
		_u.SetImage(*v)
	}
	return _u
...
func (_u *CategoryUpdate) AddFaqIDs(ids ...int) *CategoryUpdate {
	_u.mutation.AddFaqIDs(ids...)
	return _u
}

// AddFaqs adds the "faqs" edges to the FAQ entity.
func (_u *CategoryUpdate) AddFaqs(v ...*FAQ) *CategoryUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddFaqIDs(ids...)
}
...
func (_u *CategoryUpdate) ClearFaqs() *CategoryUpdate {
	_u.mutation.ClearFaqs()
	return _u
}

// RemoveFaqIDs removes the "faqs" edge to FAQ entities by IDs.
func (_u *CategoryUpdate) RemoveFaqIDs(ids ...int) *CategoryUpdate {
	_u.mutation.RemoveFaqIDs(ids...)
	return _u
}

// RemoveFaqs removes "faqs" edges to FAQ entities.
func (_u *CategoryUpdate) RemoveFaqs(v ...*FAQ) *CategoryUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveFaqIDs(ids...)
}
...
func (_u *CategoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.FaqsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   category.FaqsTable,
			Columns: []string{category.FaqsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(faq.FieldID, field.TypeInt),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := _u.mutation.RemovedFaqsIDs(); len(nodes) > 0 && !_u.mutation.FaqsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   category.FaqsTable,
	...
	if nodes := _u.mutation.FaqsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   category.FaqsTable,
...
// SetImage sets the "image" field.
func (_u *CategoryUpdateOne) SetImage(v string) *CategoryUpdateOne {
	_u.mutation.SetImage(v)
	return _u
}

// SetNillableImage sets the "image" field if the given value is not nil.
func (_u *CategoryUpdateOne) SetNillableImage(v *string) *CategoryUpdateOne {
	if v != nil {
		_u.SetImage(*v)
	}
	return _u
...
// ClearImage clears the value of the "image" field.
func (_u *CategoryUpdateOne) ClearImage() *CategoryUpdateOne {
	_u.mutation.ClearImage()
	return _u
}

// AddCourseIDs adds the "courses" edge to the Course entity by IDs.
func (_u *CategoryUpdateOne) AddCourseIDs(ids ...int) *CategoryUpdateOne {
	_u.mutation.AddCourseIDs(ids...)
	return _u
}

// AddCourses adds the "courses" edges to the Course entity.
func (_u *CategoryUpdateOne) AddCourses(v ...*Course) *CategoryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddFaqIDs adds the "faqs" edge to the FAQ entity by IDs.
func (_u *CategoryUpdateOne) AddFaqIDs(ids ...int) *CategoryUpdateOne {
	_u.mutation.AddFaqIDs(ids...)
	return _u
}

// AddFaqs adds the "faqs" edges to the FAQ entity.
func (_u *CategoryUpdateOne) AddFaqs(v ...*FAQ) *CategoryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearCourses clears all "courses" edges to the Course entity.
func (_u *CategoryUpdateOne) ClearCourses() *CategoryUpdateOne {
	_u.mutation.ClearCourses()
	return _u
}

// RemoveCourseIDs removes the "courses" edge to Course entities by IDs.
func (_u *CategoryUpdateOne) RemoveCourseIDs(ids ...int) *CategoryUpdateOne {
	_u.mutation.RemoveCourseIDs(ids...)
	return _u
}

// RemoveCourses removes "courses" edges to Course entities.
func (_u *CategoryUpdateOne) RemoveCourses(v ...*Course) *CategoryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFaqs clears all "faqs" edges to the FAQ entity.
func (_u *CategoryUpdateOne) ClearFaqs() *CategoryUpdateOne {
	_u.mutation.ClearFaqs()
	return _u
}

// RemoveFaqIDs removes the "faqs" edge to FAQ entities by IDs.
func (_u *CategoryUpdateOne) RemoveFaqIDs(ids ...int) *CategoryUpdateOne {
	_u.mutation.RemoveFaqIDs(ids...)
	return _u
}

// RemoveFaqs removes "faqs" edges to FAQ entities.
func (_u *CategoryUpdateOne) RemoveFaqs(v ...*FAQ) *CategoryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
